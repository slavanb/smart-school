...
public class Home_adapter_last extends BaseExpandableListAdapter {
    ...
    public Home_adapter_last(Context context, ArrayList<Group> groups,Home_work_fragment fragment) {
