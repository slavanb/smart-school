...
import smart_school.smartschool.Fragments.Individual_sessions_fragment;
...
public class Expand_list_adapter_individual extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<Group_individual> groups;
    ...
    private Individual_sessions_fragment fragment;

    public Expand_list_adapter_individual(Context context, ArrayList<Group_individual> groups, Individual_sessions_fragment fragment) {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        ArrayList<Child_individual> chList = groups.get(groupPosition)
                .getItems();
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        final Child_individual child = (Child_individual) getChild(groupPosition,
                childPosition);

        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) context
                    .getSystemService(context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.item_list_individual, null);
        ...
        if (listLess.get(childPosition).getOCENKI() != null) {
            ...
            switch (size) {
                ...
                case 1: {
                   ...
                   int hhh= listLess.get(childPosition).getOCENKI().get(0).getNOTONLESSON();
                ...
                case 3: {
                    ...
                    */
                    ...
                    if (listLess.get(childPosition).getOCENKI().get(2).getOcenka_progressbar() == null) {
                        ...
                        pbTwo.setProgress(Integer.parseInt(listLess.get(childPosition).getOCENKI().get(1).getOcenka_progressbar()));
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            int colorCodeDark = Color.parseColor(listLess.get(childPosition).getOCENKI().get(1).getOcenka_bal_color());
...
*/
                    ...
                    */
                    ...
                    if (listLess.get(childPosition).getOCENKI().get(3).getOcenka_progressbar() == null) {
                        ...
                        pbThree.setProgress(Integer.parseInt(listLess.get(childPosition).getOCENKI().get(1).getOcenka_progressbar()));
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            int colorCodeDark = Color.parseColor(listLess.get(childPosition).getOCENKI().get(1).getOcenka_bal_color());
                            pbThree.getProgressDrawable().setColorFilter(colorCodeDark, PorterDuff.Mode.SRC_IN);
                        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        Group_individual group = (Group_individual) getGroup(groupPosition);
        if (convertView == null) {
